...
# Asserts
TARGET_OTA_ASSERT_DEVICE := on7xltechn,SM-G6100
...
# DTB
TARGET_PREBUILT_DTB := device/samsung/on7xltechn/dt.img
...
# MKBootImg
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/on7xltechn/mkbootimg.mk
...
TARGET_RECOVERY_FSTAB := device/samsung/on7xltechn/recovery/root/etc/twrp.fstab
